...
# b) X ~ N(90, 100)
y = 50:130
plot(function(y) dnorm(y, 90, 10), 55, 130, type = 'l')

# c) Y ~ N(90, 80), Z ~ N(85, 100)
plot(function(y) dnorm(y, 90, 10), 55, 130, type = 'l', ylim=c(0, 0.05))
plot(function(y) dnorm(y, 90, sqrt(80)), 55, 130, type = 'l', col = 2, add=T)
plot(function(y) dnorm(y, 85, 10), 55, 130, type = 'l', col = 3, add=T)
