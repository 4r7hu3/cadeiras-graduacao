...
y = c(0.5,2.05,2.9,4.05,6.05,8,9.5,10.5,13.5,27.5); y
...
custom_family = function() {
  fam = poisson(link = link_custom)
  fam$variance = function(mu) mu^2
  return(fam)
}

fit0 = glm(y~x, family = custom_family()); fit0$coefficients
